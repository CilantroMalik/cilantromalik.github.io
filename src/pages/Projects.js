...
export const Projects = () => {
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            <hr style={{width: "95%"}} />
            <br/>
            <div style={{backgroundColor: "#2b3d24", borderRadius: "1rem", height: proj === "qm" ? "30vh" : "7vh", width: "70%", fontSize: "1.75vh", padding: "0 2vh", transition: "height 0.5s ease-in-out"}}
                 onMouseEnter={() => {setProj("qm"); setTimeout(() => setProj2("qm"), 500)}} onMouseLeave={() => {setProj(""); setTimeout(() => setProj2(""), 500)}}>
                <h4 style={{fontSize: "2.25vh", textAlign: "center"}}>QuantumMessenger</h4>
                {proj === "qm" &&
            ...
            <br/>
            <div style={{backgroundColor: "#2b3d24", borderRadius: "1rem", height: proj === "isfl" ? "30vh" : "7vh", width: "70%", fontSize: "1.75vh", padding: "0 2vh", transition: "height 0.5s ease-in-out"}}
                 onMouseEnter={() => {setProj("isfl"); setTimeout(() => setProj2("isfl"), 500)}} onMouseLeave={() => {setProj(""); setTimeout(() => setProj2(""), 500)}}>
                <h4 style={{fontSize: "2.25vh", textAlign: "center"}}>ISFL Fencing</h4>
                {proj === "isfl" &&
            ...
            <br/>
            <div style={{backgroundColor: "#2b3d24", borderRadius: "1rem", height: proj === "wyc" ? "30vh" : "7vh", width: "70%", fontSize: "1.75vh", padding: "0 2vh", transition: "height 0.5s ease-in-out"}}
                 onMouseEnter={() => {setProj("wyc"); setTimeout(() => setProj2("wyc"), 500)}} onMouseLeave={() => {setProj(""); setTimeout(() => setProj2(""), 500)}}>
                <h4 style={{fontSize: "2.25vh", textAlign: "center"}}>WatchYourCalendar</h4>
                {proj === "wyc" &&
            ...
            <div style={{backgroundColor: "#2b3d24", borderRadius: "1rem", height: proj === "math" ? "30vh" : "7vh", width: "70%", fontSize: "1.75vh", padding: "0 2vh", transition: "height 0.5s ease-in-out"}}
                 onMouseEnter={() => {setProj("math"); setTimeout(() => setProj2("math"), 500)}} onMouseLeave={() => {setProj(""); setTimeout(() => setProj2(""), 500)}}>
                <h4 style={{fontSize: "2.25vh", textAlign: "center"}}>High-Dimensional Sandbox</h4>
                {proj === "math" &&
